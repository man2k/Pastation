      ...
      <nav className="flex justify-between items-center px-6 md:px-20 backdrop-blur-md border-b-[0.5px] border-white bg-gray-850 relative w-full bg-zinc-950">
        <Link href="/" className="">
          ...
          <div className="flex gap-2 text-accent">
            <p className="text-white text-xl mt-2 mb-2">Pastation</p>
            <Image
              src="/assets/images/train.png"
              alt="train-logo"
              width={40}
              height={40}
              className="fixed ml-24 mt-1 bg-inherit"
            />
          </div>
        </Link>
        <Link href="/paste">
          <button className="btn bg-inherit border-[0.5px] border-stone-600 mr-14 hover:text-white">
            NEW
          </button>
        </Link>
